...
namespace accs.Database
{
   ...
   //         {
   //             new PostId { Id = 1, Name = "Командир РХБЗ", Description = "Главнокомандующий клана", Color = "#f1c40f", MaxRankId = 19 },
   //             new PostId { Id = 2, Name = "Заместитель командира РХБЗ", Description = "Заместитель главнокомандующий клана", Color = "#f1c40f", MaxRankId = 19, HeadId = 1 },
   //             new PostId { Id = 3, Name = "Начальник военной полиции", Description = "Управляет военной полицией и исполняет должностные обязанности в высшем командовании", Color = "#003eeb", SubdivisionId = 1, MaxRankId = 19, HeadId = 2 },
   //             new PostId { Id = 4, Name = "ОУп военной полиции", Description = "Особо уполномоченный военный полицейский, способный кикать и банить участников Discord сервера", Color = "#005ad3", SubdivisionId = 1, MaxRankId = 19, HeadId = 3 },
   //             new PostId { Id = 5, Name = "Военный полицейский", Description = "Офицер военной полиции, следящий за порядком в клане", Color = "#0071c9", SubdivisionId = 1, MaxRankId = 19, HeadId = 4 },
   //             new PostId { Id = 6, Name = "Начальник штаба", Description = "Управляет всеми нижестоящими подразделениями", Color = "#e92b0e", SubdivisionId = 2, MaxRankId = 19, HeadId = 2 },
   //             new PostId { Id = 7, Name = "Заместитель начальника штаба", Description = "Управляет всеми нижестоящими подразделениями", Color = "#e92b0e", SubdivisionId = 2, MaxRankId = 19, HeadId = 6 },
   //             new PostId { Id = 8, Name = "Командир", AppendSubdivisionName = true, Description = "Командир роты следит за исполнением взводных своих должностных обязанностей", Color = "#df6544", SubdivisionId = 5, MaxRankId = 19, HeadId = 7 },
   //             new PostId { Id = 9, Name = "Замполит", AppendSubdivisionName = true, Description = "Заместитель командира роты следит за исполнением взводных своих должностных обязанностей", Color = "#c05e42", SubdivisionId = 5, MaxRankId = 19, HeadId = 8 },
   //             new PostId { Id = 10, Name = "Командир", AppendSubdivisionName = true, Description = "Командир взвода поддерживает активность своего взвода и повышает своих бойцов", Color = "#9b59b6", SubdivisionId = 6, MaxRankId = 19, HeadId = 9 },
   //             new PostId { Id = 11, Name = "Заместитель командира", AppendSubdivisionName = true, Description = "Заместитель командира взвода поддерживает активность своего взвода и повышает своих бойцов", Color = "#71368a", SubdivisionId = 6, MaxRankId = 19, HeadId = 10 },
   //             new PostId { Id = 12, Name = "Командир", AppendSubdivisionName = true, Description = "Командир взвода поддерживает активность своего взвода и повышает своих бойцов", Color = "#9b59b6", SubdivisionId = 7, MaxRankId = 19, HeadId = 9 },
   //             new PostId { Id = 13, Name = "Заместитель командира", AppendSubdivisionName = true, Description = "Заместитель командира взвода поддерживает активность своего взвода и повышает своих бойцов", Color = "#71368a", SubdivisionId = 7, MaxRankId = 19, HeadId = 12 },
   //             new PostId { Id = 14, Name = "Командир", AppendSubdivisionName = true, Description = "Командир взвода поддерживает активность своего взвода и повышает своих бойцов", Color = "#9b59b6", SubdivisionId = 8, MaxRankId = 19, HeadId = 9 },
   //             new PostId { Id = 15, Name = "Заместитель командира", AppendSubdivisionName = true, Description = "Заместитель командира взвода поддерживает активность своего взвода и повышает своих бойцов", Color = "#71368a", SubdivisionId = 8, MaxRankId = 19, HeadId = 14 },
   //             new PostId { Id = 16, Name = "Командир", AppendSubdivisionName = true, Description = "Командир взвода поддерживает активность своего взвода и повышает своих бойцов", Color = "#9b59b6", SubdivisionId = 9, MaxRankId = 19, HeadId = 9 },
   //             new PostId { Id = 17, Name = "Заместитель командира", AppendSubdivisionName = true, Description = "Заместитель командира взвода поддерживает активность своего взвода и повышает своих бойцов", Color = "#71368a", SubdivisionId = 9, MaxRankId = 19, HeadId = 16 },
   //             new PostId { Id = 18, Name = "Начальник службы связи", Description = "Отвечает за всю техническую составляющую клана", Color = "#a2b800", SubdivisionId = 3, MaxRankId = 14, HeadId = 7 },
   //             new PostId { Id = 19, Name = "Офицер службы связи", Description = "Отвечает за всю техническую составляющую клана", Color = "#8c9e00", SubdivisionId = 3, MaxRankId = 14, HeadId = 18 }
   //         };
   //         modelBuilder.Entity<PostId>().HasData(posts);
   ...
   //         modelBuilder.Entity<GivedPermission<PostId>>().HasData(
   //             new GivedPermission<PostId>
   //             {
   //                 Id = 1,
